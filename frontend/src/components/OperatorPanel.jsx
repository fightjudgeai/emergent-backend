...
import { Play, Pause, ChevronRight, Eye, ChevronLeft, ArrowLeft, SkipForward, Wifi, WifiOff, Cloud, CloudOff, RefreshCw, Columns2, Undo2, PauseCircle, PlayCircle, History, Trash2 } from 'lucide-react';
