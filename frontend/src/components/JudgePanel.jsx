...
export default function JudgePanel() {
  ...
  // Distraction-Free Mode Render
  if (distractionFreeMode) {
    return (
      <div className="min-h-screen bg-black text-white flex flex-col">
        {/* Minimal Header - Auto-hide on mouse leave */}
        {showControls && (
          <div className="absolute top-0 left-0 right-0 bg-black/80 backdrop-blur p-4 z-50 transition-opacity">
            <div className="flex items-center justify-between max-w-7xl mx-auto">
              <div className="text-2xl font-bold">{bout.fighter1} vs {bout.fighter2}</div>
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="max-w-5xl w-full space-y-8">
            {/* Current Round Score - Large Display */}
            {scores[bout.currentRound] && (
              <Card className="bg-gray-900/50 border-gray-700 p-12">
                <div className="text-center space-y-6">
                  <div className="text-6xl font-bold text-amber-400">
                    {scores[bout.currentRound].card}
                  </div>
                  
                  <div className="grid grid-cols-2 gap-8 mt-8">
                    <div className="text-center">
                      <div className="text-gray-400 text-xl mb-2">{bout.fighter1}</div>
                      <div className="text-5xl font-bold text-white">
                        {scores[bout.currentRound].fighter1_score.final_score.toFixed(0)}
                      </div>
                    </div>
                    <div className="text-center">
                      <div className="text-gray-400 text-xl mb-2">{bout.fighter2}</div>
                      <div className="text-5xl font-bold text-white">
                        {scores[bout.currentRound].fighter2_score.final_score.toFixed(0)}
                      </div>
                    </div>
                  </div>
                  
                  <div className="text-2xl text-gray-400 mt-6">
                    Gap: {scores[bout.currentRound].score_gap.toFixed(0)} points
                  </div>
                </div>
              </Card>
            )}
            ...
            <div className="flex justify-center">
              <Button
                ...
                disabled={loading}
                className="bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-700 hover:to-amber-800 text-white text-2xl px-12 py-8 h-auto"
              >
                {loading ? 'Calculating...' : 'Calculate Scores (SPACE)'}
              </Button>
            </div>
            ...
            {showControls && (
              <div className="text-center text-gray-500 text-sm space-y-1">
                <div>Press SPACE to calculate • ESC to exit • H to toggle controls</div>
              </div>
            )}
          </div>
        </div>
        ...
        <Card className="bg-gradient-to-r from-[#1a1d24] to-[#13151a] border-[#2a2d35] p-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Button
                onClick={toggleDistractionFreeMode}
                className="h-10 px-4 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white"
              >
