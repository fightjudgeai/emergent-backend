...
interface UnifiedTotal { red: number; blue: number; }
type Winner = "red" | "blue" | "draw" | null;
...
export const FinalResult = memo(function FinalResult({ total, winner, redName, blueName, isVisible }: FinalResultProps) {
