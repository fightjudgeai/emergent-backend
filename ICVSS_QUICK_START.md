...
Send events to:
```
POST https://combatscore.preview.emergentagent.com/api/icvss/cv/event
```
...
BASE_URL = "https://combatscore.preview.emergentagent.com/api/icvss"
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://combatscore.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://combatscore.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://combatscore.preview.emergentagent.com/api/icvss/stats
```
