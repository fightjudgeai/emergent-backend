...
Send events to:
```
POST https://fight-scoring-pro.preview.emergentagent.com/api/icvss/cv/event
```
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://fight-scoring-pro.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://fight-scoring-pro.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://fight-scoring-pro.preview.emergentagent.com/api/icvss/stats
```
