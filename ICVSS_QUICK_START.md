...
Send events to:
```
POST https://combatjudge.preview.emergentagent.com/api/icvss/cv/event
```
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://combatjudge.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://combatjudge.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://combatjudge.preview.emergentagent.com/api/icvss/stats
```
