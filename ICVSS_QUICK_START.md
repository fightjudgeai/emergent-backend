...
Send events to:
```
POST https://mmascore.preview.emergentagent.com/api/icvss/cv/event
```
...
BASE_URL = "https://mmascore.preview.emergentagent.com/api/icvss"
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://mmascore.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://mmascore.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://mmascore.preview.emergentagent.com/api/icvss/stats
```
