...
Send events to:
```
POST https://fightscore-live.preview.emergentagent.com/api/icvss/cv/event
```
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://fightscore-live.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://fightscore-live.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://fightscore-live.preview.emergentagent.com/api/icvss/stats
```
