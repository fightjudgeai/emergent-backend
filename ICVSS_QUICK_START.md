...
Send events to:
```
POST https://sportsdash-3.preview.emergentagent.com/api/icvss/cv/event
```
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://sportsdash-3.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://sportsdash-3.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://sportsdash-3.preview.emergentagent.com/api/icvss/stats
```
