...
Send events to:
```
POST https://judge-sync-app.preview.emergentagent.com/api/icvss/cv/event
```
...
BASE_URL = "https://judge-sync-app.preview.emergentagent.com/api/icvss"
...
### **JavaScript Example**
```javascript
const BASE_URL = "https://judge-sync-app.preview.emergentagent.com/api/icvss";
...
### **Check System Health**
```bash
curl https://judge-sync-app.preview.emergentagent.com/api/icvss/health
```
...
### **Get Statistics**
```bash
curl https://judge-sync-app.preview.emergentagent.com/api/icvss/stats
```
