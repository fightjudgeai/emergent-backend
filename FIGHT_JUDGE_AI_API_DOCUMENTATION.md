...
**Base URL:** `https://scoremma.preview.emergentagent.com/api`  
...
### Basic Health Check
```bash
curl https://scoremma.preview.emergentagent.com/api/
```
...
```bash
curl -X POST https://scoremma.preview.emergentagent.com/api/calculate-score \
...
**Request:**
```bash
curl https://scoremma.preview.emergentagent.com/api/live/bout-123
```
...
**Request:**
```bash
curl https://scoremma.preview.emergentagent.com/api/fighters/John%20Doe/stats
```
...
**Request:**
```bash
curl "https://scoremma.preview.emergentagent.com/api/fighters/compare?fighter1=John%20Doe&fighter2=Jane%20Smith"
```
...
const API_BASE = 'https://scoremma.preview.emergentagent.com/api';
...
API_BASE = 'https://scoremma.preview.emergentagent.com/api'
...
1. ✅ **Base URL:** `https://scoremma.preview.emergentagent.com/api`
