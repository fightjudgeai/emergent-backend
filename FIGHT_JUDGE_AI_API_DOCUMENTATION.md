...
**Base URL:** `https://fightscoreai-1.preview.emergentagent.com/api`  
...
### Basic Health Check
```bash
curl https://fightscoreai-1.preview.emergentagent.com/api/
```
...
```bash
curl -X POST https://fightscoreai-1.preview.emergentagent.com/api/calculate-score \
...
**Request:**
```bash
curl https://fightscoreai-1.preview.emergentagent.com/api/live/bout-123
```
...
**Request:**
```bash
curl https://fightscoreai-1.preview.emergentagent.com/api/fighters/John%20Doe/stats
```
...
**Request:**
```bash
curl "https://fightscoreai-1.preview.emergentagent.com/api/fighters/compare?fighter1=John%20Doe&fighter2=Jane%20Smith"
```
...
const API_BASE = 'https://fightscoreai-1.preview.emergentagent.com/api';
...
API_BASE = 'https://fightscoreai-1.preview.emergentagent.com/api'
...
1. ✅ **Base URL:** `https://fightscoreai-1.preview.emergentagent.com/api`
