...
class ComprehensiveBackendTester:
    def __init__(self, base_url="https://fightscoreai-1.preview.emergentagent.com"):
...
if __name__ == "__main__":
    import os
    base_url = os.environ.get('BACKEND_URL', 'https://fightscoreai-1.preview.emergentagent.com')
